...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:F72585,100:C9184A&height=200&section=header&text=Hi%20there,%20I'm%20Sushant!%20💗&fontSize=38&fontColor=fff&animation=fadeIn&fontAlignY=35" width="100%"/>

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=18&pause=1200&color=F72585&center=true&vCenter=true&width=500&lines=%F0%9F%8C%B8+welcome+to+my+little+corner+of+code" />
...
```yaml
name: 🎀 Sushant
role: front-end learner in training
loves: [math, dark theme, pixel-perfect UI, note animations]
learning: SQL · Python · Power BI · scikit-learn
superpower: turning coffee into components
```

- 🪄 I sprinkle a little logic into every codebase — soft gradients, rounded corners, and zero-crash bugs *(okay, almost zero)*
- 📊 Obsessed with making things not just work, but delightful to look at
- 🌱 I write about data, open source, and the funny side of tech on my blog
- ⭐ Star a repo if you smile — it makes my day and feeds the milk tea fund
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:C9184A,100:F72585&height=100&section=footer&text=thanks%20for%20visiting!%20💗&fontSize=20&fontColor=fff" width="100%"/>
